      ...
      <section class="w-full xl:py-24 lg:py-20 py-12 bg-white border-b border-gray-300">
        <div class="w-full max-w-7xl px-6 lg:px-8 mx-auto">
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
            <div>
              <h1 class="font-manrope text-gray-900 md:text-5xl text-4xl font-bold leading-tight mb-8 lg:text-left text-center">
                Contact Us
              </h1>
              <p class="text-gray-900 text-lg font-normal leading-7 lg:text-left text-center">
              ...
              <div class="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                <div class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-black">
                  <a
                    href="javascript:;"
                    class="w-14 h-14 bg-black rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer"
                  >
                    <svg
                      class="fill-white transition-all duration-500 group-hover:fill-indigo-600"
                      width="30"
                      height="30"
                      viewBox="0 0 30 30"
                      fill="none"
                  ...
                  <h5 class="text-gray-900 text-xl font-semibold leading-8 mb-3 transition-all duration-500 group-hover:text-white">
                    Call Support
                  </h5>
                  <p class="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                    Reach out to us through the number provided below.
                  </p>
                </div>
                <div class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-green-500">
                  <a
                    href="javascript:;"
                    class="w-14 h-14 bg-black rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer"
                  >
                    <a
                      target="_blank"
                      href="https://wa.me/+254705279373?text=I'm%20interested%20in%20school"
                      className="text-white text-sm flex items-center flex-row"
                    >
                      <img
                  ...
                  <p class="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                    Chat with our support team incase anything comes up.We are
              ...
              <div class="border-t border-slate-200 pt-12 flex lg:justify-start justify-center">
                <div class="flex gap-x-1 border-r border-indigo-300 items-center">
                  ...
                  <a
                    href="javascript:;"
                    class="text-indigo-900 text-lg font-normal leading-7 pl-2.5 pr-3.5"
                  >
                    4.9 Rating
                  </a>
                </div>
                <a
                  href="javascript:;"
                  class="pl-3.5 text-indigo-900 text-lg font-normal leading-7"
                >
                  163 Reviews on{" "}
                  <span class="text-emerald-500"> Trustpilot </span>
                </a>
              </div>
            </div>
            <form
            ...
            >
              ...
              <button class="w-full h-12 rounded-full bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-indigo-50 via-green-500 to-black hover:bg-indigo-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">
                Send message{" "}
                <svg
                  width="20"
                  height="20"
