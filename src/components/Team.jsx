        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-5">
            <div className="w-full text-center md:py-8 py-5">
              <p className="text-3xl text-green-500">Administration</p>
            </div>
            <div class="flex flex-wrap justify-center gap-y-14 max-w-3xl mx-auto lg:max-w-full ">
                    ...
                    <div class="group block text-center lg:w-1/5 sm:w-1/3 min-[450px]:w-1/2 w-full">
                      <div class="relative mb-5">
                        <img
                          src={member.image}
                          alt="Guy image"
                          class="w-32 h-32 rounded-2xl object-cover mx-auto ransition-all duration-500 border-2 border-solid border-transparent group-hover:border-green-400"
                        />
                      </div>
                      <h4 class="text-xl text-gray-900 font-semibold text-center mb-2 transition-all duration-500 group-hover:text-green-400">
                        {member.name}
                      </h4>
             ...
             <div className="w-full text-center md:py-8 py-5">
              <p className="text-3xl text-green-500">Staff</p>
            </div>
